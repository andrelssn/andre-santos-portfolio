...
// Imgs
import { ToolsTechList } from "./SkillsGroups/ToolsTech";

export default function ToolsTechSkills() {

    if(!ToolsTechList) return <CircularProgress sx={{ margin: "auto" }}/>;

    return (
        <Fade in={true}>
            <div className="skill-container">
                <Grid container spacing={2}>
                    { ToolsTechList.map((data) => {
                        return (
